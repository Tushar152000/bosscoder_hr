...
export function TopNavbar({ user, notifications = [] }: Props) {
  ...
  return (
    <header className="sticky top-0 z-30 h-14 w-full border-b border-slate-200/70 bg-white flex items-center justify-between px-6">
      {/* Left: brand */}
      <Link href="/" className="flex items-center gap-2.5" aria-label="Home">
        <Brand size={28} variant="color" />
        <span className="text-[12px] font-medium tracking-[0.5px] text-[#0C447C]">
          BOSSCODER
