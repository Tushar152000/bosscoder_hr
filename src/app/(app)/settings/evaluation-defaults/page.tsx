...
export const metadata = { title: 'Evaluation defaults · Settings' };
...
export default async function EvaluationDefaultsPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <h1 className="text-[18px] font-semibold text-slate-900">Evaluation defaults</h1>
        <p className="text-[13px] text-slate-500 mt-0.5">
          Configure default questions, pillars, and scoring for review cycles.
        </p>
      </div>
      <Placeholder icon={BarChart2} label="Evaluation defaults" />
    </div>
  );
}
