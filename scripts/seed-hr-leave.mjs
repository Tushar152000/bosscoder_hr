/**
 * One-off script: seeds HR leave balances (FY2026) + backfills
 ...
 *
 * Dry-run:  node scripts/seed-hr-leave.mjs --dry-run
 * Apply:    node scripts/seed-hr-leave.mjs
 */
...
const ROWS = [
  { name: 'Shruti Jain', casualTotal: 18, casualUsed: 0, wfhUsed: 0, entries: [] },
  { name: 'Charvi', casualTotal: 18, casualUsed: 6.5, wfhUsed: 0, entries: [ // "Charvi Madaan" in the sheet; stored as "Charvi"
    { date: '2026-04-29', kind: 'half'   },
    { date: '2026-05-27', kind: 'casual' },
    { date: '2026-06-15', kind: 'casual' },
    { date: '2026-06-24', kind: 'casual' },
    { date: '2026-06-25', kind: 'casual' },
    { date: '2026-06-26', kind: 'casual' },
    { date: '2026-06-27', kind: 'casual' },
  ]},
  { name: 'Shreya Gupta', casualTotal: 18, casualUsed: 0.5, wfhUsed: 0, entries: [
    { date: '2026-04-14', kind: 'half' },
  ]},
  { name: 'Deeksha Sethi', casualTotal: 18, casualUsed: 10, wfhUsed: 0, entries: [
    { date: '2026-05-08', kind: 'casual' },
    { date: '2026-05-11', kind: 'half'   },
    { date: '2026-06-05', kind: 'half'   },
    { date: '2026-06-10', kind: 'casual' },
    { date: '2026-06-11', kind: 'casual' },
    { date: '2026-06-12', kind: 'casual' },
    { date: '2026-06-13', kind: 'casual' },
    { date: '2026-06-14', kind: 'casual' },
    { date: '2026-06-15', kind: 'casual' },
    { date: '2026-06-16', kind: 'casual' },
