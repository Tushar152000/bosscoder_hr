/**
 * One-shot script: imports Human Resources, Finance, and Legal department
 * employees into hr_employees. Skips any email that already exists.
 *
 * Run from project root:
 *   node --env-file=.env.local scripts/import-hr-finance-legal-employees.mjs
 *
 * Dry-run:
 *   node --env-file=.env.local scripts/import-hr-finance-legal-employees.mjs --dry-run
 */
...
const EMPLOYEES = [
  // Reports to E1 (Rajat Garg) — create first as she manages the rest
  { ref: 'E18',   displayName: 'Shruti Jain',     email: 'shruti.jain@bosscoderacademy.com',    designation: 'Head of Human Resources',   department: 'Human Resources', managerRef: 'E1',  joiningDate: '2022-07-19', employmentType: 'full-time' },
  // Reports to E18 (Shruti Jain)
  { ref: 'E1122', displayName: 'Charvi Madaan',   email: 'charvi.madaan@bosscoderacademy.com',  designation: 'Human Resources Executive', department: 'Human Resources', managerRef: 'E18', joiningDate: '2024-05-13', employmentType: 'full-time' },
  { ref: 'E7934', displayName: 'Deeksha Sethi',   email: 'deeksha.sethi@bosscoderacademy.com',  designation: 'Finance Executive',         department: 'Finance',         managerRef: 'E18', joiningDate: '2025-01-14', employmentType: 'full-time' },
  { ref: 'C9678', displayName: 'Noor Sarpal',     email: 'noor.sarpal@bosscoderacademy.com',    designation: 'Corporate Lawyer Intern',   department: 'Legal',           managerRef: 'E18', joiningDate: '2026-05-06', employmentType: 'intern'    },
];
...
async function main() {
  ...
  console.log(`\n✓ Done. ${created} employee(s) created across HR / Finance / Legal.\n`);
  process.exit(0);
}
